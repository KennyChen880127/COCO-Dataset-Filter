...
parser.add_argument('--yl', '--yolo_label', default=r"PersonDatasets\labels\train", type=str, help='The YOLO annotation files to be exported.')
parser.add_argument('--yi', '--yolo_img', default=r"PersonDatasets\images\train", type=str, help='The images corresponding to the annotation files to be exported.')
